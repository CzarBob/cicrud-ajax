  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
			...
			<!--<button type="button" id="b" class="btn btn-primary">View Service Record</button>
			<button type="button" id="a" class="btn btn-primary">Save changes</button> -->
			</form>
			<!--<button type="button" id="b" class="btn btn-primary">View Service Record</button> -->	
      </div>
...
<div id="myModalServiceRecord" class="modal fade" tabindex="-1" role="dialog">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
